...
# Sept. 26 2016 Presidential Debate
####################################################################
...
tweets=[]
search_results1 = twitter_api.search.tweets(q='Trump', count=100, lang='en')
search_results2 = twitter_api.search.tweets(q='Hillary', count=100, lang='en')
...
with open('../../tweet_data/test_data/candidate_data/candidates_data_'+ date, 'w') as outfile:
